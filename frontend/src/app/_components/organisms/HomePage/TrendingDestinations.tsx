      ...
      <div className="text-white pt-5 lg:pt-10 grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6">
        {TrendData.map((item, index) => (
          <Link
            ...
            href={item.link}
            className="col-span-1 lg:col-span-3 relative -tnp-feature "
          >
            <Image
              src={item.image}
              alt="trending destination one"
              loading="lazy"
              width={460}
              height={600}
              className="rounded-xl w-full h-full z-[1] object-cover transition duration-700 hover:scale-[1.15]"
            />
